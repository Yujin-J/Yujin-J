...
팀 프로젝트에서 AI 기능을 개발하고, 오픈소스 교육 자료의 한국어 번역에 참여했습니다.
아래에서 프로젝트의 담당 기능과 직접 제출한 Pull Request의 변경·병합 기록을 확인할 수 있습니다.
...
고객·연락처·상담 정보를 관리하는 CRM에 AI 챗봇을 연결하는 프로젝트에 참여했습니다.

- **담당 기능:** GPT·Gemini 연동 및 Firebase 고객·상담 데이터 기반 챗봇 구현.
- **팀 협업 기록:** 저장소에 기능별 브랜치의 Pull Request와 병합 이력이 남아 있습니다.
- **구현 확인:** 현재 공개된 챗봇 코드는 Firebase 데이터를 읽어 질문과 함께 전달하며, Gemini 형식의 API 요청·응답을 사용합니다.
...
| 직접 제출한 PR | 기여 내용 | 결과 |
| --- | --- | --- |
| [#2 — 한국어 번역](https://github.com/dotnetgirls/codespaces-project-template-dotnet/pull/2) | 도전과제 섹션의 영문 설명을 한국어로 번역 | 2024-03-13 병합 |
| [#10 — 후속 문장·용어 수정](https://github.com/dotnetgirls/codespaces-project-template-dotnet/pull/10) | Codespaces 표기, 띄어쓰기, 실습 안내 표현 개선 | 2024-03-13 병합 |

두 PR은 `Yujin-J` 계정으로 제출했고, 저장소 관리자 `pmj-chosim`이 병합했습니다. 각 PR에서 실제 문서 변경 내용과 반영 결과를 확인할 수 있습니다.
